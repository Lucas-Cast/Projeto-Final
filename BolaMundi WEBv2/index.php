...
<html lang="pt-BR">
    ...
    <head>
        ...
        <!-- Tabela CSS -->
      <!-- <link rel="stylesheet" href="css/tabelapartida.css">-->
                                ...
                                <div class="item">
                                    <blockquote>
                                        <div class="selecoescarousel">
                                          ...
                                          <a href="selecoes/selecaobrasileira.php?id=1"><button type="submit" class="selecoes-inner" style="color: #FFFFFF">Clique Aqui</button></a>              
                                        </div>
                                    </blockquote>
                                </div>
                                <div class="item">
                ...
                <!-- API -->
                    ...
                    <div class="container">
                            <div class="col-md-3 col-sm-6" style= "width: 1125px">
                               <div id="wg-api-football-livescore" data-host="v3.football.api-sports.io" data-refresh="60" data-key="52bdc83e957e93a6343e282ebcf1ff57" data-theme="dark" data-show-errors="false" class="api_football_loader"> </div>
                          </div>
                    </div> 
