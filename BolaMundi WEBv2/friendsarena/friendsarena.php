...
<html lang="pt-br">
  ...
  <head>
    ...
    <title>Friends Arena</title>

    <link href="https://fonts.googleapis.com/css?family=Poppins:100,200,300,400,500,600,700,800,900" rel="stylesheet">

    <!-- Plugin CSS -->

    <link href="js/friendsarena/vendor/bootstrap/css/bootstrap.min.css" rel="stylesheet">
        ...
        <div class="col-lg-6">
          <div class="row">
            ...
            <div class="col-lg-6">
              <div class="row">
                <div class="col-12">
                  <div class="facts-area-content new-facts">
